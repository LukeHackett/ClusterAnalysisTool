...
\afterpage{
  ...
  \begin{landscape}
    ...
    \begin{figure}
      \centering
        \includegraphics[scale=0.75]{chapter7/sequence_diagrams/single_week_cluster_weekly.png}
...
\afterpage{
  ...
  \begin{landscape}
    ...
    \begin{figure}
      \centering
        \includegraphics[scale=0.75]{chapter7/sequence_diagrams/single_week_cluster_product.png}
        \caption[Sequence diagram of a single week being clustered]
                {Sequence diagram of a single week being clustered and analysed 
